import clip
from clipActor.utils import device, clip_model, create_video
from clipActor.sent2vec import Sent2Vec
import clipActor.cfg as cfg
import clipActor.retrieval_ as rtr
...
#____________________新增clipActor的检索部分____________________________________________________________________
...
L = body_pose.shape[0]  # 一个motion sequence的帧数
...
new_pose = smpl_out_lst[2].full_pose     # 输出的full_pose是旋转向量（轴角表示）
new_pose[:, :3] = 0.
